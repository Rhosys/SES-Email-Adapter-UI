...
<template>
  <span
    ...
    class="rounded-full bg-ctp-red px-2 py-0.5 text-xs font-bold text-ctp-base"
    aria-label="Critical urgency"
    >!</span
  >
  <span
    v-else-if="urgency === 'high'"
    class="rounded-full bg-ctp-peach px-2 py-0.5 text-xs font-bold text-ctp-base"
